...
namespace DVLD_BLL
{
    public class clsLicense
    {
        ...
        public clsLicense(int ID, int ApplicationID, int DriverID, int LicenseClass,
...

        {
            ...
            this.LicenseClassInfo = clsLicenseClass.FindByLicenseCLassID(this.LicenseClass);
            this.DetainedInfo = clsDetainedLicense.FindByLicenseID(this.ID);
        ...
        private bool _AddNewLicense()
        {
            ...
            this.ID = clsDataLicense.AddNewLicense(this.ApplicationID, this.DriverID, this.LicenseClass,
        ...
        private bool _UpdateLicense()
        {
            ...
            return clsDataLicense.UpdateLicense(this.ID, this.ApplicationID, this.DriverID, this.LicenseClass,
               this.IssueDate, this.ExpirationDate, this.Notes, this.PaidFees,
               this.IsActive, (byte)this.IssueReason, this.CreatedByUserID);
        }
        ...
        public static clsLicense Find(int ID)
        {
            ...
            byte IssueReason = 1;
            if (clsDataLicense.GetLicenseInfoByID(ID, ref ApplicationID, ref DriverID, ref LicenseClass,
        ...
        public static DataTable GetDriverLicenses(int DriverID)
            => clsDataLicense.GetDriverLicenses(DriverID);

        public Boolean IsLicenseExpired()
            => (this.ExpirationDate < DateTime.Now);

        public bool DeactivateCurrentLicense()
            => clsDataLicense.DeactivateLicense(this.ID);
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            Application.AppTypeID = (int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicense;
            Application.AppStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = (float)clsApplicationType.Find((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicense).Fees;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicantPersonID = this.DriverInfo.PersonID;
            Application.Date = DateTime.Now;
            Application.AppTypeID = (int)clsApplication.enApplicationType.RenewDrivingLicense;
            Application.AppStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.AppStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = (float)clsApplicationType.Find(Application.AppTypeID).Fees;
            Application.CreatedByUserID = CreatedByUserID;
